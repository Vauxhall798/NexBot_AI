...
Blueprint:"""
    ...
    try:
        ...
        generator_prompt = (
            ...
            "8. CHART CONTAINER ALIGNMENT (CRITICAL): Ensure the `.card` wrapping each chart has `display: flex; flex-direction: column; height: 100%;`. The `div` wrapping each `<canvas>` MUST have `flex-grow: 1; min-height: 350px; position: relative; margin-top: 16px;` to force all charts to align perfectly vertically regardless of title height.\n"
