...
def gemini_prompt(prompt: str, params: dict = None) -> str:
    ...
    try:
        ...
        if '429' in error_str or 'quota' in error_str or 'rate' in error_str:
            print(f"[API FALLBACK] 429 Rate Limit Hit on {GEMINI_MODEL}. Falling back to gemini-2.0-flash...")
...
Blueprint:"""
    ...
    try:
        ...
        generator_prompt = (
            ...
            "7. KPI BADGES: Must contain actual text (e.g., '+12.4%'). Style them with soft background pills.\n"
