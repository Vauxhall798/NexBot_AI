...
Blueprint:"""
    ...
    try:
        ...
        generator_prompt = (
            ...
            "9. Colors: Use #6366f1 (Indigo), #10b981 (Emerald), #f43f5e (Rose), #f59e0b (Amber), #8b5cf6 (Purple). For Bar, Pie, and Doughnut charts, you MUST assign an array of these vibrant colors to `backgroundColor` so every bar/slice has a beautiful, distinct color. NEVER use black or monochromatic bars.\n"
