...
Blueprint:"""
    ...
    try:
        ...
        generator_prompt = (
            ...
            "7. ASYMMETRICAL CHART GRID: Use `display: grid; grid-template-columns: 1fr 2fr; gap: 20px; margin-bottom: 24px;` to match the Operations Strategy layout (e.g., small charts on left, wide map/chart on right).\n"
            "8. CHART CANVAS HEIGHT: Ensure the `div` wrapping each `<canvas>` has `height: 350px; position: relative; margin-top: 16px;`.\n"
